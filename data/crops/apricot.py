crop_data = {
    "apricot": {
        ...
        "climate": "Cool temperate with dry summers",
        ...
        "drainage_requirement": "Avoid standing water",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "35-60 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '48 kcal', 'carbohydrates': '11 g', 'fiber': '2 g', 'vitamin_A': '96 mcg', 'potassium': '259 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/apricot.jpg",
            "pests": [
