crop_data = {
    "cherry": {
        ...
        "soil_depth_requirement": "Deep soils",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "25-45 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '63 kcal', 'carbohydrates': '16 g', 'fiber': '2.1 g', 'vitamin_C': '7 mg', 'potassium': '222 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/cherry.jpg",
            "pests": [
