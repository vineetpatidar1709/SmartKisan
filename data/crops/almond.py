crop_data = {
    "almond": {
        ...
        # -------------------------------------------------
        "season": "Annual (flowering in spring)",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "4-8 quintals (kernel equivalent)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '579 kcal', 'protein': '21 g', 'fat': '50 g', 'fiber': '12.5 g', 'vitamin_E': '25.6 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/almond.jpg",
            "pests": [
