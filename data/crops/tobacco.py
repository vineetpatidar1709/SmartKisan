crop_data = {
    "tobacco": {
        ...
        "crop_type": "Leaf commercial crop",

        # -------------------------------------------------
        # BASIC CULTIVATION DETAILS
        # -------------------------------------------------
        "season": "Kharif/Rabi depending on type and region",
        "duration_days": "120-160 days",
        ...
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Light loam to sandy loam",
        "soil_ph_range": "5.5 - 7.5",
        "soil_depth_requirement": "Moderately deep soil",
        "salinity_tolerance": "Low to moderate",
        "drainage_requirement": "Well-drained fields required",
 ...
 'blight': {'description': 'Blight under humid stress.',
        ...
        "average_yield_per_acre": "8-15 quintals cured leaves",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': 'Not consumed as food',
 ...
 'Economic value is based on industrial use'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/tobacco.jpg",
            "pests": [
