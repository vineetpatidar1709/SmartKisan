crop_data = {
    "litchi": {
        ...
        "family": "Sapindaceae",
        "category": "Fruit Crop",
        "crop_type": "Subtropical fruit tree",
        ...
        "climate": "Subtropical with cool winter",
        ...
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Deep loam with good organic carbon",
        "soil_ph_range": "5.5 - 7.0",
        "soil_depth_requirement": "Deep, well-drained soil",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Avoid prolonged waterlogging",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "30-60 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '66 kcal',
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/litchi.jpg",
            "pests": [
