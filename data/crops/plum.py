crop_data = {
    "plum": {
        ...
        "soil_ph_range": "5.8 - 7.2",
        "soil_depth_requirement": "Deep and fertile",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Well-drained soil needed",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "30-55 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '46 kcal',
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/plum.jpg",
            "pests": [
