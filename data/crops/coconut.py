crop_data = {
    "coconut": {
        ...
        "crop_type": "Perennial palm crop",

        # -------------------------------------------------
        # BASIC CULTIVATION DETAILS
        # -------------------------------------------------
        "season": "Annual",
        "duration_days": "Perennial (productive for decades)",
        "climate": "Humid tropical",
        "ideal_temperature": "20 C - 32 C",
        "germination_temperature": "27 C - 32 C",
        "rainfall_requirement_mm": "1000 - 2500 mm",
        ...
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Coastal alluvial to lateritic",
        "soil_ph_range": "5.0 - 8.0",
        "soil_depth_requirement": "Deep soil with good aeration",
        "salinity_tolerance": "Moderate",
        "drainage_requirement": "Good drainage to prevent root rot",
 ...
 'blight': {'description': 'Blight under humid stress.',
        ...
        "average_yield_per_acre": "7000-10000 nuts/year",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '354 kcal', 'fat': '33 g', 'carbohydrates': '15 g', 'fiber': '9 g', 'manganese': '1.5 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/coconut.jpg",
            "pests": [
