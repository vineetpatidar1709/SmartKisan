crop_data = {
    "pineapple": {
        ...
        # -------------------------------------------------
        "season": "Annual (staggered planting)",
        "duration_days": "14-18 months to first harvest",
        ...
        "drainage_requirement": "No water stagnation",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '50 kcal',
 'carbohydrates': '13 g',
 'fiber': '1.4 g',
 'vitamin_C': '47.8 mg',
 'manganese': '0.93 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/pineapple.jpg",
            "pests": [
