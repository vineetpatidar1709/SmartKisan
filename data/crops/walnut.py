crop_data = {
    "walnut": {
        ...
        "family": "Juglandaceae",
        "category": "Dry Fruit Crop",
        "crop_type": "Temperate tree crop",
        ...
        "soil_depth_requirement": "Deep root zone required",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "6-12 quintals (in-shell nuts)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '654 kcal', 'protein': '15 g', 'fat': '65 g', 'fiber': '6.7 g', 'omega_3': '2.5 g ALA'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/walnut.jpg",
            "pests": [
