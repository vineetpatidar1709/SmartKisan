crop_data = {
    "arecanut": {
        ...
        # -------------------------------------------------
        "season": "Annual",
        "duration_days": "Perennial (bearing starts after 5-7 years)",
        "climate": "Humid tropical",
        "ideal_temperature": "20 C - 35 C",
        "germination_temperature": "25 C - 35 C",
        "rainfall_requirement_mm": "1500 - 3000 mm",
        "water_requirement_level": "High",
        "sunlight_requirement": "Bright light, partial shade in young stage",
        ...
        "soil_depth_requirement": "Deep fertile soils",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Very good drainage",
 ...
 'blight': {'description': 'Blight under humid stress.',
        ...
        "average_yield_per_acre": "8-15 quintals (dry nuts)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '339 kcal', 'carbohydrates': '47 g', 'fiber': '25 g', 'fat': '4 g', 'iron': '2.5 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/arecanut.jpg",
            "pests": [
