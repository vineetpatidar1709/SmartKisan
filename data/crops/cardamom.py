crop_data = {
    "cardamom": {
        ...
        # -------------------------------------------------
        "season": "Annual",
        "duration_days": "Perennial (bearing from 2nd-3rd year)",
        "climate": "Cool humid tropical highland",
        "ideal_temperature": "15 C - 30 C",
        "germination_temperature": "20 C - 28 C",
        ...
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Forest loam rich in humus",
        "soil_ph_range": "5.5 - 6.8",
        "soil_depth_requirement": "Deep friable soil",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Well drained with mulch cover",
 ...
 'wilt_complex': {'description': 'Complex decline due to pathogens/stress.',
        ...
        "average_yield_per_acre": "2-4 quintals (dry capsules)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '311 kcal', 'carbohydrates': '68 g', 'fiber': '28 g', 'protein': '11 g', 'manganese': '28 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/cardamom.jpg",
            "pests": [
