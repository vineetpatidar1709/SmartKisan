crop_data = {
    "orange": {
        ...
        "family": "Rutaceae",
        "category": "Fruit Crop",
        "crop_type": "Citrus orchard crop",

        # -------------------------------------------------
        # BASIC CULTIVATION DETAILS
        # -------------------------------------------------
        "season": "Annual (multiple flushes)",
        ...
        "rainfall_requirement_mm": "900 - 1400 mm",
        ...
        "soil_depth_requirement": "Deep soil with aeration",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '47 kcal', 'carbohydrates': '12 g', 'fiber': '2.4 g', 'vitamin_C': '53 mg', 'folate': '30 mcg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/orange.jpg",
            "pests": [
