crop_data = {
    "guava": {
        ...
        "family": "Myrtaceae",
        "category": "Fruit Crop",
        "crop_type": "Tropical fruit crop",

        # -------------------------------------------------
        # BASIC CULTIVATION DETAILS
        # -------------------------------------------------
        "season": "Annual (multiple flowering seasons)",
        "duration_days": "Perennial fruit tree",
        "climate": "Tropical and subtropical",
        "ideal_temperature": "20 C - 35 C",
        "germination_temperature": "22 C - 30 C",
        "rainfall_requirement_mm": "600 - 1200 mm",
        ...
        "soil_ph_range": "5.0 - 7.5",
        "soil_depth_requirement": "Medium to deep soils",
        "salinity_tolerance": "Moderate",
        "drainage_requirement": "Good drainage",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "80-140 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '68 kcal', 'carbohydrates': '14 g', 'fiber': '5.4 g', 'vitamin_C': '228 mg', 'folate': '49 mcg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/guava.jpg",
            "pests": [
