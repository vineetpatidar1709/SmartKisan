crop_data = {
    "jackfruit": {
        ...
        "family": "Moraceae",
        "category": "Fruit Crop",
        "crop_type": "Tropical perennial fruit tree",
        ...
        "ideal_temperature": "24 C - 35 C",
        "germination_temperature": "25 C - 32 C",
        "rainfall_requirement_mm": "1000 - 2400 mm",
        ...
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Deep alluvial to lateritic soils",
        "soil_ph_range": "5.5 - 7.5",
        "soil_depth_requirement": "Deep fertile soils",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Well-drained site preferred",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "80-150 quintals (fruit weight)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '95 kcal',
 'carbohydrates': '23 g',
 'fiber': '1.5 g',
 'vitamin_C': '13.7 mg',
 'potassium': '448 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/jackfruit.jpg",
            "pests": [
