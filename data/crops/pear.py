crop_data = {
    "pear": {
        ...
        "climate": "Temperate and cool subtropical",
        "ideal_temperature": "10 C - 28 C",
        "germination_temperature": "16 C - 24 C",
        "rainfall_requirement_mm": "800 - 1200 mm",
 ...
 'root_rot': {'description': 'Soil-borne root disease under poor drainage.',
        ...
        "average_yield_per_acre": "40-70 quintals",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '57 kcal',
 'carbohydrates': '15 g',
 'fiber': '3.1 g',
 'vitamin_C': '4.3 mg',
 'potassium': '116 mg'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/pear.jpg",
            "pests": [
