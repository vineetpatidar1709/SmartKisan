crop_data = {
    "ginger": {
        ...
        "category": "Spice Crop",
        "crop_type": "Rhizome spice crop",

        # -------------------------------------------------
        # BASIC CULTIVATION DETAILS
        # -------------------------------------------------
        "season": "Kharif (Apr-Jun planting)",
        "duration_days": "210-270 days",
        "climate": "Warm humid tropical",
        "ideal_temperature": "20 C - 30 C",
        "germination_temperature": "22 C - 30 C",
        "rainfall_requirement_mm": "1200 - 2000 mm",
        "water_requirement_level": "Moderate",
        "sunlight_requirement": "Partial shade to filtered sun",

        # -------------------------------------------------
        # SOIL REQUIREMENTS
        # -------------------------------------------------
        "soil_type": "Loose friable loam rich in organics",
        "soil_ph_range": "5.5 - 6.5",
        "soil_depth_requirement": "Well-drained, deep soil",
        "salinity_tolerance": "Low",
        "drainage_requirement": "Avoid water stagnation",
 ...
 'wilt_complex': {'description': 'Complex decline due to pathogens/stress.',
        ...
        "average_yield_per_acre": "60-100 quintals (green rhizome)",
        ...
        # NUTRITION PROFILE
        # -------------------------------------------------
        "nutrition_per_100g": {'calories': '80 kcal',
 'carbohydrates': '18 g',
 'fiber': '2 g',
 'potassium': '415 mg',
 'gingerol': 'Bioactive compounds present'},
 ...
 'Contains crop-specific functional compounds'],
        ...
        # -------------------------------------------------
        "images": {
            "crop": "static/images/crops/ginger.jpg",
            "pests": [
